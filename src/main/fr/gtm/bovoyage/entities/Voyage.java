...
public class Voyage {
	...
	/**
	 * Cette methode permet de calculer le prix total Hors Taxe d'un voyage en
	 * fonction du nombre de voyageur.
	 * 
	 * @return retourne le prixTotalHT sous forme de double.
	 */
