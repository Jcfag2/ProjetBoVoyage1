...
public interface DestinationDAO {
	...
	/**
	 * Signature de la methode qui sert a creer une destination.
	 * 
	...
	/**
	 * Signature de la methode qui sert a supprimer une destination.
	 * 
	 * @param d Le parametre d correspond a l'objet Destination
	 */
	...
	/**
	 * Signature de la methode qui sert a mettre a jour une destination.
	 * 
	 * @param d Le parametre d correspond a l'objet Destination
	 */
	...
	/**
	 * Signature de la methode qui sert a recuperer toutes les destinations pour une
	 * region donnee.
	 * 
	 * @param region Le parametre region permet de definir le nom de la region
	 *               recherchee.
	...
	/**
	 * Signature de la methode qui sert a recuparer une destination par son numero
	 * identifiant.
	 * 
	 * @param id Le parametre id permet de definir l'id de la destination
	 *           recherchee.
	...
	/**
	 * Signature de la methode qui sert a recuperer la liste des dates de voyage
	 * disponibles pour une destination donnee.
	 * 
	 * @param d Le parametre d correspond a l'objet Destination
	...
	/**
	 * Signature de la methode qui sert a recuperer une liste contenant toutes les
	 * destinations.
	 * 
