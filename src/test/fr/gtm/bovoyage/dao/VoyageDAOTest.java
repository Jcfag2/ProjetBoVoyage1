...
public class VoyageDAOTest {
	...
	private Voyage[] voyages = { new Voyage("Maroc", "Il fait chaud et il y a du sable", 123, date1, c1, voyageurs),
	...
	public void testCreate() {
		...
		Voyage vvv = new Voyage("Tatooïne",
				"I don't like sand, it's coarse and rough an irritating and it gets everywhere.", 357, date1, c1,
				voyageurs);
